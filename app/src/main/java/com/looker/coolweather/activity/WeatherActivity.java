...
import com.looker.coolweather.R;
import com.looker.coolweather.util.HttpCallbackListener;
...
public class WeatherActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    * */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        weatherInfoLayoyt = (LinearLayout) findViewById(R.id.weather_info_layout);
    ...
    * */
    private void showWeather() {
        ...
        publishText.setText("今天" + prefs.getString("weather_desp", "") + "发布");
